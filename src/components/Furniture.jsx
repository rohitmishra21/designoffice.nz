  ...
  <div className='anim relative bg-[#EDEDED]'>
     <div className="w-full h-screen grid grid-cols-6 grid-rows-3 gap-3 px-3 py-3">
                ...
                <div className="border border-dotted z-40 border-black relative flex flex-col justify-end ">
                    ...
                    <h1 className='text-xl capitalize leading-none'>brand photography</h1>
                    <h1 className='text-xl capitalize leading-none'>campaign identity</h1>
                </div>
     </div>
     <div className='top-3 absolute w-[65%] h-[60%] left-3 bg-[url("https://images.prismic.io/motionsickness/d9e71da3-09de-466b-a3d9-466a1e1f09d5_design-office-test-3.jpg?ixlib=js-3.3.0&auto=format%2C%20compress&rect=0%2C0%2C5760%2C3240&w=1000&h=1125&dpr=2&q=50")] bg-cover bg-center bg-no-repeat' >
